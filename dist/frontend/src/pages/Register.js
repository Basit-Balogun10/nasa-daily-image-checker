...
const Register = () => {
    ...
    const onSubmit = (e) => {
        ...
        if (password !== password2) {
            ...
            userData = {
                firstName: (0, utils_1.capitalizeString)(firstName),
                lastName: (0, utils_1.capitalizeString)(lastName),
                email,
                password,
            };
        }
        axios_1.default
            ...
            .then((res) => {
            react_toastify_1.toast.success("Account created successfully", {
    ...
    return (<>
            <section className="heading">
                ...
                <p>Please create an account to see today's image</p>
                <div className="google-btn-container">
                    <GoogleButton_1.default buttonText="Sign up with Google" onClickHandler={googleSignupHandler}/>
                </div>
            </section>
            ...
            <section className="form">
                <form onSubmit={onSubmit}>
                    <div className="form-group">
                        <input type="text" className="form-control" id="first_name" name="firstName" value={firstName} placeholder="Enter your first name" onChange={onChange}/>
                    </div>
                    <div className="form-group">
                        <input type="text" className="form-control" id="last_name" name="lastName" value={lastName} placeholder="Enter your last name" onChange={onChange}/>
                    </div>
                    <div className="form-group">
